...
// SELECT ROW PAGINATION
var table = '#mytable'
$('.option').on('click', function () {
    $('.ui--pagination').html()
    var trnum = 0
    var rowlimit = document.getElementById('max-row');
    var rowvalue = rowlimit.innerHTML;
    // alert(rowvalue);
    var maxRows = parseInt(rowvalue)
